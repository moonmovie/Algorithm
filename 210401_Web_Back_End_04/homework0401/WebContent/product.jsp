<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.ssafy.product.model.UsersDto"%>
...
$(document).ready(function () {
        ...
        $('#submit').on("click",()=>{
           if($("#id").val()!=null&&$('#name').val()!=null && $('#price').val()!=null && $('#info').val()!=null){
...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<a class="navbar-brand">${userinfo.userName}</a>
